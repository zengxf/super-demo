...
public class MyServerTest {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        bs.group(elg);
        bs.channel(NioServerSocketChannel.class);       // 设置 NIO 类型的 Channel
        bs.localAddress(new InetSocketAddress(PORT));   // 设置监听端口
        ...
        ChannelFuture cf = bs.bind().sync(); // sign_demo_001
    ...
    public static void main(String[] args) {
        ...
        cf.addListener((ChannelFuture f) -> {
            if (f.isSuccess()) {
                ...
                channel.flush(); // 消息体太短，需要强制推送，否则服务端接收不到
