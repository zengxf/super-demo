...
java.lang.RuntimeException: 栈跟踪-1
    ...
    at *.rpc.protocol.ProtocolListenerWrapper.refer(ProtocolListenerWrapper.java:84)
    at *.rpc.cluster.filter.ProtocolFilterWrapper.refer(ProtocolFilterWrapper.java:72)
    at *.rpc.protocol.ProtocolSerializationWrapper.refer(ProtocolSerializationWrapper.java:55)
