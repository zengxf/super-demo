...
java.lang.RuntimeException: 栈跟踪-1
    at org.apache.dubbo.registry.nacos.NacosServiceDiscovery.getInstances(NacosServiceDiscovery.java:151)       // 查找服务，ref: sign_m_160
    ...
    at org.apache.dubbo.rpc.protocol.ProtocolSecurityWrapper.refer(ProtocolSecurityWrapper.java:112)    // ref: sign_m_350
    ...
    at org.apache.dubbo.config.ReferenceConfig.createProxy(ReferenceConfig.java:486)    // 创建代理，ref: sign_m_232
    at org.apache.dubbo.config.ReferenceConfig.init(ReferenceConfig.java:369)
    at org.apache.dubbo.config.ReferenceConfig.get(ReferenceConfig.java:238)            // 获取引用，ref: sign_m_240
...
- `org.apache.dubbo.rpc.proxy.javassist.JavassistProxyFactory`
  - 底层处理参考：[客户端调用-代理调用处理器 sign_m_110](./客户端调用.md#代理调用处理器)
```java
// sign_c_430
